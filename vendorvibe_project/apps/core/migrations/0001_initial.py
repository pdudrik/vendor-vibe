    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_category', models.CharField(choices=[('MA', 'Marketing'), ('LE', 'Legal'), ('FI', 'Finance'), ('IT', 'IT Support'), ('GO', 'Goods')], max_length=2)),
        ...
        migrations.AddField(
            model_name='contract',
            name='vendor',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='contracts', to='core.vendor'),
        ),
        migrations.CreateModel(
            name='Contact',
            fields=[
                ...
                ('vendor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='contacts', to='core.vendor')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('street_opt', models.CharField(blank=True, max_length=30, null=True)),
                ('state_provinence', models.CharField(blank=True, max_length=30, null=True)),
                ('postal_code', models.CharField(max_length=10)),
                ('country', django_countries.fields.CountryField(max_length=2)),
                ('address_type', models.CharField(choices=[('BI', 'Billing'), ('SH', 'Shipping'), ('HQ', 'Headquarters')], max_length=2)),
                ('vendor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='addresses', to='core.vendor')),
            ],
            options={
